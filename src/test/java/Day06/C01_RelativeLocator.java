...
public class C01_RelativeLocator {
    ...
    public class c01RelativeLocator extends Base {


        @Test
        public void relatioveLocator() {
//above,toLeftOf,below,toRightOf,near=>methodları ile buton ve input kontrolleri yapılır...
...
//        mexicoLinkTest  Verify if the link is displayed.
            ...
            //By cancelLocator=RelativeLocator.with(By.tagName("button")).below(By.xpath("//div[text()='Cancel']"));
//(hata verebilir xpath dogrulamalısın!!!)
