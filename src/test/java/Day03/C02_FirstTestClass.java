...
public class C02_FirstTestClass {
  ...
  @Ignore//clasdan çalıştırınca ıgnore edr fakat test seviyesinde run edince çalışır
  @Test
  public void test03(){
...
//before ve after classar objeden bağımsız olması gerektiği için static olmalıdır...
  @AfterClass
