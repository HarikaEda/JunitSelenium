...
//        driver.switchTo().newWindow(WindowType.TAB); -> Yeni sekme olusturur.
...
driver.get("https://www.amazon.com/");
    System.out.println("Amazon sekmesi window handle: " + driver.getWindowHandle());
    driver.switchTo().newWindow(WindowType.TAB);
driver.get("https://www.linkedin.com/");
    System.out.println("LinkedIn sekmesi window handle: " + driver.getWindowHandle());
    driver.switchTo().newWindow(WindowType.WINDOW);
    driver.get("https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
    System.out.println("Open Source sekmesi window handle: " + driver.getWindowHandle());
   // driver.close();->aktif olan sekmeyi kapatır.
    driver.quit();//tüm pencere ve sekmeleri kapatır.
