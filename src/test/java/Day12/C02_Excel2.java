...
public class C02_Excel2 {
    ...
    public void test() throws IOException {
        ...
        //getPhysicalNumberOfRows() metodunu kullanilan row(satır) sayisini bize verir..
        System.out.println("lastRowNumber = " + lastRowNumber);

        for (int i = 0; i <= lastRowIndex; i++) {//lastRowIndex oluğu için <= kullandık,lastRowNumber olsaydı< işareti kullanmamız gerekirdi.
