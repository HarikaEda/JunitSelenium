...
public class C01_XpathPractice extends Base {
    ...
    public void test1() throws InterruptedException {
        ...
        password.sendKeys("admin123");//hoca dolanbaçlı yolu da göstermek için bu kadar uzun yaptı
        //*yer tutucu bana element buluyor,
    ...
    @Test
    public void test02() throws InterruptedException {//negatif test
