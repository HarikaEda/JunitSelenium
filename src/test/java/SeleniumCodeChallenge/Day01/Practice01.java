package SeleniumCodeChallenge.Day01;
...
//3. Verify that home page is visible successfully
        ...
        Assert.assertTrue("Enter Account Information is visible",information.isDisplayed());
        WebElement titleMrs= driver.findElement(By.xpath("//*[@id='id_gender2']"));
        titleMrs.click();
        WebElement genderSelection = driver.findElement(By.xpath("//input[@value='Mrs']"));
        ...
        WebElement continueButton = driver.findElement(By.className("btn btn-primary"));
        continueButton.click();
        WebElement loginSuccess=driver.findElement(By.xpath("//a[contains(.,'Logged in as)]"));
        ...
        deleteAccount.click();
        WebElement continueButton1 = driver.findElement(By.className("btn btn-primary"));
        Assert.assertTrue("It's visible", driver.findElement(By.tagName("b")).isDisplayed());
